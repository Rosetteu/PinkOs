...
app.main = function()
    ...
    grafic.drawSquare(3, 3, grafic.screenSize[1] - 5, 3, app.localStyle.divColor or PinkOsSettings.style.divColor)

    grafic.drawSquare(3, 7, grafic.screenSize[1] - 5, grafic.screenSize[2] - 7,
        app.localStyle.divColor or PinkOsSettings.style.divColor)

    grafic.createButton(function()
            if string.len(calc) < grafic.screenSize[1] - 7 then
                calc = calc .. "7"
            end
    ...
    grafic.createButton(function()
            ...
            grafic.drawSquare(3, 3, grafic.screenSize[1] - 5, 3, app.localStyle.divColor or PinkOsSettings.style
                .divColor)
    ...
    while true do
        ...
        if event == "mouse_click" and mouseButton == 1 then
            ...
            if string.find(calc, "=") then
                ...
                grafic.drawSquare(3, 3, grafic.screenSize[1] - 5, 3,
                    app.localStyle.divColor or PinkOsSettings.style.divColor)
                grafic.drawString(calc, 4, 4, app.localStyle.divTextColor or PinkOsSettings.style.divTextColor,
                    app.localStyle.divColor or PinkOsSettings.style.divColor)
            else
                grafic.drawString(calc, 4, 4, app.localStyle.divTextColor or PinkOsSettings.style.divTextColor,
                    app.localStyle.divColor or PinkOsSettings.style.divColor)
